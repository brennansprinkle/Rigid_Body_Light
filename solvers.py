...
def solver_EMmid(Nbodies, Nblobs, Force, Slip, cb, Tol, X_Guess, verbose=False):
    #gamma = 1.0
...
def solver_EMRFD(Nbodies, Nblobs, Force, Slip, cb, dt, kBT, Tol, U_guess, Xs_start, Qs_start, verbose=False):
    start = time.time()
